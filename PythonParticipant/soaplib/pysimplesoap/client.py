...
import tempfile
from soaplib.pysimplesoap.simplexml import SimpleXMLElement, REVERSE_TYPE_MAP, OrderedDict
from soaplib.pysimplesoap.transport import get_Http
import logging
...
class SoapClient(object):
    ...
    def __init__(self, location = None, action = None, namespace = None,
        ...
        self.certssl = cert             
        self.keyssl = None              
        self.location = location        # coordinationserver location (url)
