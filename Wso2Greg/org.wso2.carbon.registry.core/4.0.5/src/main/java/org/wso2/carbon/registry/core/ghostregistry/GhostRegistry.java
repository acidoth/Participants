...
public class GhostRegistry implements Registry{
    ...
    public Resource get(String path, String transactionId) throws RegistryException {
        return getRegistry().get(path,transactionId);  //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public String put(String suggestedPath, Resource resource, String transactionId) throws RegistryException {
        return getRegistry().put(suggestedPath, resource,transactionId);  //To change body of implemented methods use File | Settings | File Templates.
    }
