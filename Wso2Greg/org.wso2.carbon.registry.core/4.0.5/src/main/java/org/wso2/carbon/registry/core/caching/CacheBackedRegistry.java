...
public class CacheBackedRegistry implements Registry {
    ...
    public String put(String suggestedPath, Resource resource, String transactionId) throws RegistryException {
        return registry.put(suggestedPath,resource,transactionId);  //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public boolean prepare(String transactionId) throws RegistryException {
        return registry.prepare(transactionId);  //To change body of implemented methods use File | Settings | File Templates.
    }

    @Override
    public boolean commit(String transactionId) {
        return registry.commit(transactionId);  //To change body of implemented methods use File | Settings | File Templates.
    }

    @Override
    public boolean rollback(String transactionId) {
        return registry.rollback(transactionId);  //To change body of implemented methods use File | Settings | File Templates.
    }
