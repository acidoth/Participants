...
public class UserRegistry implements Registry {
    ...
    protected static final Log log = LogFactory.getLog(UserRegistry.class);
     ...
     */
    protected ChrootWrapper chrootWrapper;
    ...
    public UserRegistry(String userName, String password, int tenantId,
        ...
        String tenantUserName = new String(userName);
...
//                    }
    ...
    public String rename(String currentPath, String newPath) throws RegistryException {
        ...
        try {
            String updatedNewPath = new String(newPath);
            // setting session information + chrooted incoming paths
            setSessionInformation();
    ...
    public void addAssociation(String sourcePath, String targetPath, String associationType)
        ...
        try {
            // setting session information + chrooted incoming paths
            setSessionInformation();
            String updatedTargetPath = new String(targetPath);
    ...
    public void removeAssociation(String sourcePath, String associationPath,
        ...
        try {
            // setting session information + chrooted incoming paths
            setSessionInformation();
            String updatedAssociationPath = new String(associationPath);
            // Don't fix target path if it is not an external URL.
     ...
     */
    protected final void clearSessionInformation() {
    ...
    public String put(String suggestedPath, Resource resource, String transactionId) throws RegistryException {
        ...
        try {
            ...
            return coreRegistry.put(chrootWrapper.getInPath(suggestedPath), resource,transactionId);
            //returningPath = super.chrootWrapper.getOutPath(returningPath);
        } finally {
            clearSessionInformation();
        }
    }
    ...
    @Override
    public boolean prepare(String transactionId) throws RegistryException {
        ...
        try {
            ...
            isSucess = coreRegistry.prepare(transactionId);
            //returningPath = super.chrootWrapper.getOutPath(returningPath);
    ...
    public boolean commit(String transactionId) {
        ...
        try {
            ...
            isSucess = coreRegistry.commit(transactionId);
            //returningPath = super.chrootWrapper.getOutPath(returningPath);
    ...
    public boolean rollback(String transactionId) {
        ...
        try {
            ...
            isSucess = coreRegistry.rollback(transactionId);
            //returningPath = super.chrootWrapper.getOutPath(returningPath);
