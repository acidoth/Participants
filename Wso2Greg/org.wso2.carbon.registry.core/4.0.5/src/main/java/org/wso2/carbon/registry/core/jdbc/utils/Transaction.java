...
public class Transaction {
    ...
    public static void pushTransaction(String transactionId){
         Transaction.dataAccessManager.getDatabaseTransaction().pushATransaction(transactionId);
    }

    public static void popTransaction(String transactionId){
         Transaction.dataAccessManager.getDatabaseTransaction().popATransaction(transactionId);
    }
