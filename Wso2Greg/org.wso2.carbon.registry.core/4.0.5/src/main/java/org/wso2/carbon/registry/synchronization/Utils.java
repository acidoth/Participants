...
//            }
    ...
    public static OMElement createDefaultMetaFile(boolean isCollection,
        ...
        child = factory.createOMElement(new QName(ELEM_CREATED_TIME));
        ...
        // set LastModified
        child = factory.createOMElement(new QName(ELEM_LAST_MODIFIED));
        child.setText(Long.toString(now));
        root.addChild(child);
    ...
    public static void addResource(String path) throws SynchronizationException {
        ...
        String metaFile = path.substring(0, path.lastIndexOf(File.separator)) +
