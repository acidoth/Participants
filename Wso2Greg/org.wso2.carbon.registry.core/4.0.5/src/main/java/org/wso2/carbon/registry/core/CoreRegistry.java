...
public interface CoreRegistry extends org.wso2.carbon.registry.api.CoreRegistry {
    ...
    Resource get(String path, String transactionId) throws RegistryException;
    ...
    //Collection get(String path, int start, int pageSize, String transactionId) throws RegistryException;
    ...
    String put(String suggestedPath, Resource resource, String transactionId) throws RegistryException;
    /**
    ...
    boolean prepare(String transactionId) throws RegistryException;
