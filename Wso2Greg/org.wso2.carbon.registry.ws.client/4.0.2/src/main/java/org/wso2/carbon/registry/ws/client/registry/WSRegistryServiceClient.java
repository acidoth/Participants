...
public class WSRegistryServiceClient implements Registry {
    ...
    public WSRegistryServiceClient(String serverURL, String username, String password,
                                   ConfigurationContext configContext, CoordinationContext coordinationContext)
            throws RegistryException {
    ...
    public void addCoordinationContext(CoordinationContext coordinationContext){
        stub._getServiceClient().removeHeaders();
        stub._getServiceClient().addHeader(WSRegistryClientUtils.getContextToHeader(coordinationContext));
    }
    ...
    @Override
    public Resource get(String s, String s2) throws RegistryException {
    ...
    @Override
    public String put(String path, Resource resource, String transactionId) throws RegistryException {
        return path;
    }
